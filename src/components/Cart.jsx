...
const Cart = () => {
  ...
  return (
    <>
      <div
        className={`fixed right-0 top-0 w-full sm:w-[80vw] md:w-[50vw] lg:w-[20vw] h-full p-5 bg-white shadow-lg z-50 ${
      ...
      >
        <div className="flex justify-between items-center my-3">
          ...
          <FaWindowClose
            ...
            className="ml-auto text-2xl cursor-pointer p-1 rounded-md hover:text-red-300 hover:border-red-300 transition-colors"
          />
        </div>
